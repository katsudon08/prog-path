...
import { useMazeStore, type MazeData, findStartPosition } from '@/legacy/entities/maze';
import { useRobotStore, type RobotState } from '@/legacy/entities/robot';
import { type Command, type CommandType } from '@/legacy/entities/command';
import { useCommandStore, useCommandBuilder } from '@/legacy/features/command-management';
import { useSimulationStore } from '@/legacy/features/maze-simulation/model/useSimulationStore';
import { useSimulationRunner } from '@/legacy/features/maze-simulation/model/useSimulationRunner';
import { ARPlaygroundWidget } from '@/legacy/widgets/ar';
import { MazeView3DWidget } from '@/legacy/widgets/maze-view-3d';
