...
import { useMazeStore, saveMazesToStorage, validateMaze, type MazeData } from '@/legacy/entities/maze'
import type { ActionResult } from '@/legacy/shared/model'
import { decodeMazeFromQR, isMazeQRCode } from '@/legacy/shared/lib'
