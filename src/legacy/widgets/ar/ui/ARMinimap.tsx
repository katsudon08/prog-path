...
import { MazeData } from '@/legacy/entities/maze';
import { MazePreview2D } from '@/legacy/entities/maze/ui/2d/MazePreview2D';
import { RobotState, RobotAnimationState } from '@/legacy/entities/robot';
