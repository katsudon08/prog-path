...
import { useHomePortalState } from "@/src/features/home-portal-state";
                        ...
                        <div>
                            {Object.entries(groupedMazes).sort((a, b) => {
                                ...
                                >
                                    ...
                                    >
                                        <ChevronDown
                                            className={`h-4 w-4 text-neon-cyan transition-transform ${expandedCategories.has(category) ? "" : "-rotate-90"
                                                }`}
                                        />
                                    ...
                                    {expandedCategories.has(category) && (
                                        <div className="p-2 space-y-2">
                                            {categoryMazes.map((maze) => (
                                                <Card
                                                    key={maze.id}
                                                    className={`p-3 cursor-pointer border transition-all hover:border-neon-cyan/50 ${selectedMaze?.id === maze.id
